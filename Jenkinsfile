pipeline {
    ...
    stages {
        ...
        stage('key'){
            steps {
                sh '''
                  sed -e 's/$access_key/access_key/g' /var/lib/jenkins/workspace/terragods/variables.tf
                  sed -e 's/$secret_key/secret_key/g' /var/lib/jenkins/workspace/terragods/variables.tf
                  '''
                  }
            }
